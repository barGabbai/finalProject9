...
$(document).ready(function () {
    ...
    var topOfWhoWeAreDiv = $("#whoAreWePage").offset().top - 470;
    var topOfNumbersDiv = $("#numbersPage").offset().top - 470;
    var topOfSayingDiv = $("#sayingPage").offset().top - 470;
    var topOfContactDiv = $("#contactPage").offset().top-620;
