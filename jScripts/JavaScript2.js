$(document).ready(function () {
    ...
    $('#q4SliderWork .ui-slider-label[data-value=1]').text('לא מרוצה כלל');
    $('#q4SliderWork .ui-slider-label[data-value=5]').text('מרוצה מאוד').css("text-align","center");
    $('#q4SliderFam .ui-slider-label[data-value=1]').text('לא מרוצה כלל');
    $('#q4SliderFam .ui-slider-label[data-value=5]').text('מרוצה מאוד');
    $('#q4SliderFri .ui-slider-label[data-value=1]').text('לא מרוצה כלל');
    $('#q4SliderFri .ui-slider-label[data-value=5]').text('מרוצה מאוד');
    $('#q4SliderEdu .ui-slider-label[data-value=1]').text('לא מרוצה כלל');
